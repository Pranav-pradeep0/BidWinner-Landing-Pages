...
const Help = () => {
    return (
        <Box sx={{ backgroundColor: 'white', paddingBlock: { xs: '50px' } }}>
            <Box sx={{ display: 'flex', minHeight: '600px', width: { xs: '100%', md: 'max-content' }, flexDirection: { xs: 'column', md: 'row', }, justifyContent: 'space-around', alignItems: 'center', marginInline: 'auto', gap: '60px' }}>
                <Box sx={{}}>
                    <CardMedia
                        component="img"
                        image="https://i.postimg.cc/3w4tKHyK/Mac-Book-Pro-16-1.png"
                    />
                </Box>

                <Box sx={{ maxWidth: '570px', display: 'flex', flexDirection: 'column', gap: '10px', paddingInline: '20px', }}>
                    <Typography sx={{ fontWeight: '300', fontSize: '30px' }}>Contact Us</Typography>
                    <Typography sx={{ fontWeight: '600', fontSize: '38px' }}>We're here to help</Typography>
